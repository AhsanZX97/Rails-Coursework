...
class FixturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fixture" do
    assert_difference('Fixture.count') do
      post fixtures_url, params: { fixture: { away_id: @fixture.away_id, awaygoals: @fixture.awaygoals, home_id: @fixture.home_id, homegoals: @fixture.homegoals, league_id: @fixture.league_id } }
    end
  ...
  test "should update fixture" do
    patch fixture_url(@fixture), params: { fixture: { away_id: @fixture.away_id, awaygoals: @fixture.awaygoals, home_id: @fixture.home_id, homegoals: @fixture.homegoals, league_id: @fixture.league_id } }
